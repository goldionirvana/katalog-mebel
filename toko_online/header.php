...
<div id="contact">
<ul>
       <li><i class="fa fa-phone-square"></i> Phone : 0877-5971-6994</li>
       <li><i class="fa fa-envelope-o"></i> Email : info@xxxxxx.com</li>
       <li><i class="fa fa-building-o"></i> Office : Jl. Jolondriyo No.62, Krapyakrejo, Kec. Gadingrejo, Kota Pasuruan, Jawa Timur 67137</li>
...
<div id="header_content">	<!--start header conteent-->
	<ul>
	  ...
	  <li><a href="index.php?clear=y"><img src="images/mapan.png" width=40% ></a></li>
	  <li> <?php
